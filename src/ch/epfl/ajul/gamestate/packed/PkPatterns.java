...
public final class PkPatterns {
    ...
    /// @param line
    ///        la ligne de motif dont on veut connaître le nombre de tuiles
    ...
    ///        les lignes de motif empaquetées
    /// @param line
    ///        la ligne de motif dont on veut connaître la couleur (ne doit pas être vide)
    ...
    ///        les lignes de motif empaquetées
    /// @param line
    ///        la ligne de motif à laquelle ajouter les tuiles (doit pouvoir contenir la couleur donnée
